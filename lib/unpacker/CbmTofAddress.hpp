...
class CbmTofAddress
{
   public:
      ...
      /** Builder **/
          ...
          ** @return  address
          **/
      static unsigned int GetUniqueAddress( unsigned int Sm, unsigned int Rpc, unsigned int Channel, unsigned int Side = 0, unsigned int SmType = 0) {
         return static_cast<unsigned int>( ( ( kTof    & ( ( 1 << fgkSystemBits      ) - 1 ) )                         ) +
