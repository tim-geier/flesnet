...
class CbmTofDigi
{
   public:
       ...
       **/
      CbmTofDigi( unsigned int Sm, unsigned int Rpc, unsigned int Channel, 
      ...
      /** Assignment operator  **/
      CbmTofDigi& operator=(const CbmTofDigi&);


      /** Move Assignment operator  **/
      CbmTofDigi& operator=(CbmTofDigi&&);
      ...
      /** Accessors **/
          ...
          **/
      int GetAddress() const { return   ( (flData >> fgkiAddressOffs) & fgklAddrMask ); };
      ...
      int GetSystemId() const { return CbmTofAddress::GetSystemId( GetAddress() ); };
          ...
          ** @brief Inherited from CbmDigi.
          **/
      double GetTime() const { return fgkdTimeBinSize * ( (flData >> fgkiTimeOffs)    & fgklTimeMask ); };

         /**
          ** @brief Inherited from CbmDigi.
          **/
      double GetCharge() const { return fgkdTotBinSize * ( (flData >> fgkiTotOffs)     & fgkiTotOffs ); };
         /**
      ...
      long long int GetData()    const { return flData; };
          ...
          **/
      virtual bool operator <( const CbmTofDigi& rhs) const; 
      //virtual int	 Compare(      const TObject* obj) const;
      virtual int	 Compare(      const CbmTofDigi*  obj) const;
...
// -----------------------------------------------------------------------------
      ...
      static const double fgkdTimeBinSize; // [ps] => 41 943.40 ns ( > GET4 epoch, > trigger window)
